...
## 1 PANDUAN ADMIN EXPO KAMPUS
**Untuk Panitia Expo**

### A. ADMIN PANEL (HANYA ADMIN WA/OWNER)
| Command | Format | Contoh |
|---------|--------|--------|
| `.setwelcome` | `.setwelcome [teks]` | `.setwelcome Halo @user! 🎓` |
| `.setgoodbye` | `.setgoodbye [teks]` | `.setgoodbye Semoga sukses!` |
| `.setinfo` | `.setinfo [teks]` | `.setinfo Kampus terakreditasi A` |
