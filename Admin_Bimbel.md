...
### B. ADMIN PANEL (HANYA ADMIN WA/OWNER)
| Command | Format | Contoh |
|---------|--------|--------|
| `.setkelas` | `.setkelas Kls Hari Jam Mapel` | `.setkelas 12A Senin 08:00 MTK` |
| `.addtryout` | `.addtryout Tgl Jam \| Judul` | `.addtryout 25-01-2026 09:00 \| Tryout` |
| `.addskor` | `.addskor @tag [poin]` | `.addskor @Haqi 50` |
| `.minusskor` | `.minusskor @tag [poin]` | `.minusskor @Haqi 10` |

### C. CEK JADWAL (SEMUA MEMBER)
| Command | Fungsi |
|---------|--------|
| `.listkelas` | Lihat jadwal kelas |
| `.tryout` | Lihat jadwal tryout |
| `.myskor` | Cek poin sendiri |
| `.topskor` | Lihat ranking |
