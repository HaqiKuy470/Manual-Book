...
## 1 PANDUAN ADMIN KOMUNITAS
**Untuk Admin Grup Umum**

### A. GHOST SIDER DETECTOR (HANYA ADMIN WA/OWNER)
| Command | Format | Contoh |
|---------|--------|--------|
| `.sider on/off` | Aktifkan/nonaktifkan | `.sider on` |
...
| `.antivirtex on/off` | Blokir text panjang |
| `.antitoxic on/off` | Blokir kata kasar |
| `.izinkan @tag` | Beri izin share link |

### C. WELCOME SYSTEM (HANYA ADMIN WA/OWNER)
| Command | Format | Contoh |
|---------|--------|--------|
| `.setwelcome` | `.setwelcome [teks]` | `.setwelcome Halo @user! 🎉` |
| `.setgoodbye` | `.setgoodbye [teks]` | `.setgoodbye Selamat tinggal!` |
| `.welcome on/off` | Aktifkan/nonaktifkan | `.welcome on` |

### D. LEVELING SYSTEM (SEMUA MEMBER)
| Command | Fungsi |
|---------|--------|
| `.ceklevel` | Cek level & XP |
